...
<%@page import="com.rays.pro4.controller.User1Ctl"%>
				...
				<table align="center">
					<tr>
						...
						<td colspan="2">&nbsp; &emsp; <input type="submit"
							name="operation" value="<%=User1Ctl.OP_UPDATE%>"> &nbsp;
							&nbsp; <input type="submit" name="operation"
							value="<%=User1Ctl.OP_CANCEL%>"></td>
						...
						<td colspan="2"><input type="submit" name="operation"
							value="<%=User1Ctl.OP_SAVE%>">&nbsp; &nbsp; <input
							type="submit" name="operation" value="<%=User1Ctl.OP_RESET%>"></td>
						</center>
						<%
							}
						%>
