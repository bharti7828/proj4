			...
			<div align="centre">
				...
				<table width="100%" align="center">
					<tr>
						...
						<input type="text" name="product"  onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength="20"
						...
						<input type="text" name="customer"   maxlength="20"
						
						placeholder="Enter  Customer"
							value="<%=ServletUtility.getParameter("customer", request)%>">
						&nbsp;
					</tr>
