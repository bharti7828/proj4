	...
	<center>
		...
		<form action="<%=ORSView.BANK_CTL%>" method="post">
			...
			<div align="center">
				...
				<%
				HashMap map  = (HashMap) request.getAttribute("bankNamee");
			...
			<table>
				...
				<tr>
					...
					<td><input type="number" name="accountNo" maxlength="12"
						placeholder="Enter AccountNo" style="width: 195px" 
						value="<%=DataUtility.getStringData(bean.getAccountNo()).equals("0") ? ""
					: DataUtility.getStringData(bean.getAccountNo())%>"></td>
				...
				<tr>
				 ...
				 <tr>
				 <th align="left">BankName<span style="color: red">*</span>:</th>
				 <td>
				 <%= HTMLUtility.getList("bankName", String.valueOf(bean.getBankName()), map)%></td>
				...
				<table align="center">
					<tr>
						...
						<td colspan="2"><input type="submit" name="operation"
							...
							type="submit" name="operation" value="<%=BankCtl.OP_RESET%>"></td>
						</center>
						<%
							}
						%>
