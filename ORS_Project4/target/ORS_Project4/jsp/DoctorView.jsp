...
<tr>
					<th align="left"> Expertise Role <span style="color: red">*</span> :
					</th>
					<td><%=HTMLUtility.getList("expertise", String.valueOf(bean.getExpertise()), eList)%></td>
					<td style="position: fixed"><font style="position: fixed"
						color="red"> <%=ServletUtility.getErrorMessage("expertise", request)%></font></td>
				</tr>
